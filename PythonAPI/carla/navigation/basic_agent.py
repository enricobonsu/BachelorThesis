...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, target_speed=30.0, opt_dict={}, map_inst=None, grp_inst=None):
        ...
        self._base_tlight_threshold = 4.0#5.0  # meters
    ...
    def _affected_by_traffic_light(self, lights_list=None, max_distance=None):
        ...
        if self._last_traffic_light:
            if self._last_traffic_light.state != carla.TrafficLightState.Red:
                ...
                return (True, self._last_traffic_light,1)
        ...
        for traffic_light in lights_list:
            ...
            if math.ceil(trigger_wp.transform.location.distance(ego_vehicle_location)) > max_distance:
                continue
